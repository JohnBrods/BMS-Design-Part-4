...
void main(){
   ...
   // unsigned char VoltageSampleHigh, VoltageSampleLow;
    ...
    LATD3_bit = 0;
    LATD4_bit = 0;
    Write_Number_One(200,80,white);
    Write_Number_Two(200,140,white);
  while(1){
          ...
          if(y <=50){
            BatteryVoltage1 = 0.00099951171875 * BatteryVoltage1;        //4.904 is voltage from 5 volt regulator to Microchip ADC CELL ONE
            LATD1_bit = 0;
            Write_Float_Number(BatteryVoltage1,20,80,Lime);  //My new float
            Write_Number_C(160,80,Red);
            Write_Number_C(160,140,White);
           }



          if(y >50){
            BatteryVoltage2 = 0.0012275390625 * BatteryVoltage2;        //5.028 is voltage from 5 volt regulator to Microchip ADC CELL 4
            LATD1_bit = 1;
            Write_Float_Number(BatteryVoltage2,20,140,Lime);  //My new float
            Write_Number_C(160,80,White);
            Write_Number_C(160,140,Red);
           }


          Write_Number(y,200,200,lime);
